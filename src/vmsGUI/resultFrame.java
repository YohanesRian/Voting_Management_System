...
public class resultFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSave.setBackground(new java.awt.Color(79, 193, 132));
        btnSave.setFont(new java.awt.Font("Bebas", 0, 24)); // NOI18N
        btnSave.setForeground(new java.awt.Color(250, 243, 227));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(cbElectionName, javax.swing.GroupLayout.PREFERRED_SIZE, 410, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(cbElectionName.getSelectedItem() == null){
            ...
            if(model.getRowCount() > 0){
                fileResult fr = new fileResult(model.getDataVector(), el.getElectionName());
                fr.saveFile();
                JOptionPane.showMessageDialog(this, "Success", "Success", JOptionPane.PLAIN_MESSAGE);
            }
            else{
                JOptionPane.showMessageDialog(this, "Empty Table", "Empty Table", JOptionPane.ERROR_MESSAGE);
            }
        }
