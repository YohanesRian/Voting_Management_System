...
public class adminSettingFrame extends javax.swing.JFrame {

    private user vo;
    
    public adminSettingFrame() {
        initComponents();
    }
    
    public adminSettingFrame(user vo) {
        initComponents();
        this.vo = vo;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminSettingFrame().setVisible(true);
            }
        });
    }
